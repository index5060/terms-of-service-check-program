    ...
    riskFactors: [
      {
        ...
        description: "개인정보보호위원회(PIPC) 및 KISA 광고성 정보 수신 가이드라인을 충실히 반영하여, 단순 식음료 및 매장 프로모션 메세지에 한정된 안전한 마케팅 조항입니다.",
        level: "safe",
        ...
        aiAnalysisComment: "개인정보보호위원회(PIPC)의 생성형 AI 개발 및 활용 가이드라인과 KISA의 서비스 분야별 수칙을 성실히 준수하여 설계되었습니다. 외부 금융사로의 유출이나 부당한 대행 이관이 전혀 포함되지 않아 식음료 리워드 혜택 한정으로 안심하고 사용하셔도 좋은 구조입니다.",
        remedyActionTip: "스팸 예방 차원에서 SMS 및 메일 수신이 원치 않으시면, '[선택] E-mail 및 SMS 광고성 정보 수신동의'의 체크박스를 꺼 두시는 것만으로 충분히 차단됩니다."
      }
    ],
    baseSummary: [
